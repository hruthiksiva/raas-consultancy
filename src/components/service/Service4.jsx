...
const Service4 = () => {
  ...
  return (
    <section id="service4" className="py-10 md:py-24" style={{ backgroundColor: '#FFFFFF' }}>
      <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:grid lg:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          <div className="order-2 w-full lg:order-2">
            ...
            <h2 className="text-2xl md:text-4xl font-bold mb-4 md:mb-6" style={{ color: '#141A1F' }}>{service4Data.title}</h2>
            <p className="text-base md:text-lg mb-6 md:mb-8 leading-relaxed" style={{ color: '#141A1F' }}>{service4Data.description}</p>
