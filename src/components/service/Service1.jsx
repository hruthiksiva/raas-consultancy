...
import service1Data from '../../data/service1.json';
      ...
      <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:grid lg:grid-cols-2 gap-8 md:gap-12 items-center">
          <div className="order-1 w-full lg:order-2">
            <div className="rounded-2xl p-4 md:p-8">
              <div className="w-full h-40 md:h-80 rounded-lg flex items-center justify-center overflow-hidden">
                <img src={Service1Pic} alt={service1Data.imageLabel} className="object-cover w-full h-full rounded-lg" />
              </div>
            </div>
          </div>
          <div className="order-2 w-full lg:order-1">
            ...
            <h2 className="text-2xl md:text-4xl font-bold mb-4 md:mb-6" style={{ color: '#FFFFFF' }}>{service1Data.title}</h2>
            <p className="text-base md:text-lg mb-6 md:mb-8 leading-relaxed" style={{ color: '#FFFFFF' }}>{service1Data.description}</p>
            <div className="space-y-3 md:space-y-4 mb-6 md:mb-8">
              {service1Data.features.map((feature, idx) => (
